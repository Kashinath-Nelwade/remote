...
function SessionPage() {
  ...
  // safe problem id access
  const problemId = session?.problem || "session-problem";

  // Submissions Hook (after session exists)
  const { submissions, addSubmission } = useSubmissions(problemId);
  ...
  // Auto-join session for participant
  useEffect(() => {
              ...
              {isInitializingCall ? (
                ...
                <div className="flex items-center justify-center h-full">
                  <div className="card bg-base-100 shadow-xl p-6 text-center">
                    <PhoneOffIcon className="w-12 h-12 mx-auto mb-4 text-error" />
                    <h2 className="text-xl font-bold">Connection Failed</h2>
                    <p className="text-base-content/60">Could not connect.</p>
                  </div>
                </div>
              ) : (
                <StreamVideo client={streamClient}>
